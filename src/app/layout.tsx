...
export const metadata: Metadata = {
  title: "Fiasko Flowers Studio | Premium Floral Design & Arrangements",  description: "Exquisite custom floral arrangements for weddings, events, and special occasions. Premium floristry by Fiasko Flowers Studio.",  keywords: "flowers, floral arrangements, wedding flowers, event design, custom bouquets, florist",  openGraph: {
    title: "Fiasko Flowers Studio | Premium Floral Design",    description: "Exquisite floral arrangements crafted with passion and artistry. Discover Fiasko's premium flower designs.",    siteName: "Fiasko Flowers",    type: "website",    images: [
      {
        url: "https://img.b2bpic.net/free-photo/close-up-pretty-floral-decoration_23-2147609389.jpg",        alt: "Premium floral arrangement by Fiasko"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Fiasko Flowers Studio | Premium Floral Design",    description: "Discover exquisite floral arrangements and custom designs.",    images: ["https://img.b2bpic.net/free-photo/close-up-pretty-floral-decoration_23-2147609389.jpg"]
  },
  robots: {
    index: true,
    follow: true
